...
public class Motorista {
    ...
    private Motorista(@NonNull String nome, int idade, int pontos, @NonNull String habilitacao) {
        this.nome = nome;
        this.idade = idade;
        this.pontos = pontos;
    ...
    public boolean isHabilitacaoSuspensa() {
        return pontos > 20;
    }
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            if(idade < 1) throw new IllegalArgumentException(Mensagem.IDADE_NEGATIVA);
            this.idade = idade;
            return this;
        }

        public MotoristaBuilder withPontos(int pontos) {
            if(pontos < 0) throw new IllegalArgumentException(Mensagem.HABILITACAO_PONTOS_NEGATIVOS);
            this.pontos = pontos;
            return this;
        }
